...
Redmine::Plugin.register :redmine_graphs do
  ...
  settings :default => {:open_aging_issues_enabled => 1, :total_issues_over_time_enabled => 1, :total_bugs_over_time_enabled => 1, :total_vs_closed_issues_enabled => 1, :dummy_value => "dummy value"}, :partial => 'settings/graphs'
